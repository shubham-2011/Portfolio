  ...
  try {
    ...
    return NextResponse.json({
      ...
      stats: {
        ...
        embeddingModel: hasGemini ? 'Google text-embedding-004 (768-dim)' : 'Local High-Precision Semantic Projection (384-dim)',
        generationModel: hasGemini ? 'Google Gemini 1.5 Flash' : 'Grounded Semantic Synthesis',
      },
    });
  } catch (error: any) {
